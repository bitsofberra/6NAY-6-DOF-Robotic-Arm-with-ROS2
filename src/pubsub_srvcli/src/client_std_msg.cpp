...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<pubsub_srvcli::srv::AddThreeInts>::SharedPtr client =                        
    node->create_client<pubsub_srvcli::srv::AddThreeInts>("add_three_ints");                 

  auto request = std::make_shared<pubsub_srvcli::srv::AddThreeInts::Request>();               
